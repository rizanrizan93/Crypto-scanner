...
from crypto_scanner.market_models import decimal_optional, decimal_required
...
def parse_wallet_snapshot(item: dict[str, object]) -> WalletSnapshot:
    ...
    coins = tuple(parse_wallet_coin(coin) for coin in coins_raw if isinstance(coin, dict))
